...
namespace TrackerLibrary
{
    public static class TournamentLogic
    {
        ...
        // Create every round after that - (8 teams -> 4 matchups -> 2 matchups -> 1 matchup)

        public static void CreateRounds(TournamentModel model)
        {
            List<Models.TeamModel> randomizedTeams = RandomizeTeamOrder(model.EnteredTeams);
        ...
        private static int CheckCurrentRound(this TournamentModel model)
        {
            ...
            CompleteTounament(model);
            return output - 1;
        }

        private static void CompleteTounament(TournamentModel model)
        {
            ...
            if ( runnerUpPrize > 0)
            {
                body.AppendLine($"<p>{runnerUp.TeamName} will receive ${runnerUpPrize} for winning the tournament!</p>");
            }
        ...
        private static List<TeamModel> RandomizeTeamOrder(List<Models.TeamModel> teams)
        {
